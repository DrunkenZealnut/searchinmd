...
| `hwpx_results_refresh_20260914.json` | `hwpx_results_refresh.py` | 기초보고서 HWPX 제3장 1~3절 재작성의 변경 대조 — 문단 45(구/신 숫자 목록·출처)·표 7(바뀐 셀 수)·그림 3(형식·크기·sha256)·숫자 감사(토큰 715, 미일치 0). 새 HWPX 는 `data/`(비추적) | 연구용 — 보고서 문장은 담지 않음 |
