...
- **Depends on**: 1·3 은 연구책임자 결정, 2 는 `resegment.py` 재사용 설계, 4·5 는 결정 불필요, 6 은 정본 워크북 복귀 뒤 재실행.
