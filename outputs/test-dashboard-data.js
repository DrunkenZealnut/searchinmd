...
check('S5i index.html 정적 히어로의 공유 쪽 등급 일치 == summary reseg_agreement (브리지와 같은 N/N (100%) 형식)', vNcs.includes('공유 쪽 등급 일치 ' + fmt(S.meta.run.reseg_agreement.agree) + '/' + fmt(S.meta.run.reseg_agreement.pages) + ' (' + pct(S.meta.run.reseg_agreement.agree, S.meta.run.reseg_agreement.pages) + '%)'));
